...
using GigHub.Identity.Data;
using GigHub.Identity.Models;
using GigHub.Identity.Services;

// HostingStartup's in the primary assembly are run automatically.
[assembly: HostingStartup(typeof(GigHub.Identity.IdentityServiceStartup))]
